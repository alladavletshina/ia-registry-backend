...
# ⬇⬇⬇⬇⬇⬇⬇⬇⬇ ОБНОВЛЕН СПИСОК ОБЯЗАТЕЛЬНЫХ ДИРЕКТОРИЙ ⬇⬇⬇⬇⬇⬇⬇⬇⬇
...
# ⬇⬇⬇⬇⬇⬇⬇⬇⬇ ДОБАВЛЕНА ПРОВЕРКА НОВЫХ СЕРВИСОВ ⬇⬇⬇⬇⬇⬇⬇⬇⬇
...
build_service() {
    ...
    # ⬇⬇⬇⬇⬇⬇⬇⬇⬇ ДОБАВЛЕНА ПРОВЕРКА ДЛЯ Maven/Gradle ⬇⬇⬇⬇⬇⬇⬇⬇⬇
...
# ⬇⬇⬇⬇⬇⬇⬇⬇⬇ ДОБАВЛЕНЫ НОВЫЕ СЕРВИСЫ ДЛЯ СБОРКИ ⬇⬇⬇⬇⬇⬇⬇⬇⬇
...
# ⬇⬇⬇⬇⬇⬇⬇⬇⬇ ОБНОВЛЕН ПОИСК DOCKER-COMPOSE ФАЙЛОВ ⬇⬇⬇⬇⬇⬇⬇⬇⬇
COMPOSE_FILES=("docker-compose.yml" "docker-compose.keycloak.local.yml" "docker-compose.full.yml")
COMPOSE_FILE=""
...
if [ -z "$COMPOSE_FILE" ]; then
    ...
    # ⬇⬇⬇⬇⬇⬇⬇⬇⬇ ОБНОВЛЕН docker-compose.yml ШАБЛОН ⬇⬇⬇⬇⬇⬇⬇⬇⬇
...
# ⬇⬇⬇⬇⬇⬇⬇⬇⬇ ДОБАВЛЕНЫ ПЕРЕМЕННЫЕ ДЛЯ УСЛОВНОГО ЗАПУСКА ⬇⬇⬇⬇⬇⬇⬇⬇⬇
...
# ⬇⬇⬇⬇⬇⬇⬇⬇⬇ ОБНОВЛЕН СПИСОК СЕРВИСОВ ДЛЯ ПРОВЕРКИ ⬇⬇⬇⬇⬇⬇⬇⬇⬇
SERVICES_TO_CHECK=(
    "8082:API Gateway"
    "8084:Asset Service"
)
...
# ⬇⬇⬇⬇⬇⬇⬇⬇⬇ ОБНОВЛЕН СПИСОК ПРОВЕРЯЕМЫХ СЕРВИСОВ ⬇⬇⬇⬇⬇⬇⬇⬇⬇
...
# Проверяем дополнительные сервисы, если они запущены
